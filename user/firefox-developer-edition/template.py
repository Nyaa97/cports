...
pkgver = "133.0.2"
_pkgver = "b".join(pkgver.rsplit(".", 1))
pkgrel = 0
hostmakedepends = [
    "automake",
    "cargo",
...
source = f"$(MOZILLA_SITE)/firefox/releases/{_pkgver}/source/firefox-{_pkgver}.source.tar.xz"
sha256 = "1ed259be691b6b219ac395914499e1cf01f3bc58c3599c0bea88bf3718755a7b"
